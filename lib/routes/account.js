...
var SQSReminder = require('../sqs_reminder')
var verificationReminderQueue = new SQSReminder(config.region)
          ...
          .then(
            function (result) {
              ...
              if (account.emailVerified) {
                ...
                // unverified accounts get enrolled into verification reminder queue
